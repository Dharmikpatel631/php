                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                                ...
                                $row = mysqli_num_rows($result);
                                if ($row <= 0) {
                                    $result = mysqli_query($con, "INSERT INTO  tbl_banner(banner_Url,banner_image_1440px_X_499px,banner_image_768px_X_499px,banner_image_425px_X_499px,is_active,created_on) VALUE ('$bannerurl','$FileName1','$FileName2','$FileName3','yes','now()')") or die(mysqli_error($con));
                                    if ($result == true) {
                                    ?>
                                        <div class="alert alert-primary shadow" role="alert">
                                            <strong> Hi! </strong> Form Inserted
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="hidden" name="oldimg1" data-default-file="../images/Bannerads/<?php if (isset($row1)) echo $row1["banner_image_1440px_X_499px"] ?>" value="<?php echo $row2["banner_image_1440px_X_499px"] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <pre></pre>
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="hidden" name="oldimg2" data-default-file="../images/Bannerads/<?php if (isset($row1)) echo $row1["banner_image_768px_X_499px"] ?>" value="<?php echo $row2["banner_image_768px_X_499px"] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <pre></pre>
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="hidden" hidden name="oldimg3" data-default-file="../images/Bannerads/<?php if (isset($row1)) echo $row1["banner_image_425px_X_499px"] ?>" value="<?php echo $row2["banner_image_425px_X_499px"] ?>" >
                                                    </div>
                                                </div>
                                            </div>
                                            <pre></pre>
        ...
        $(document).ready(function() {
            ...
            $("#form1").validate({
                ...
                messages: {
                    ...
                    bannerimg1: {
                        required: "Please enter the desktop banner (1440px X 499px).",

                    },
                    bannerimg2: {
                        required: "Please enter the Tablet banner (768px X 499px).",

                    },
                    bannerimg3: {
                        required: "Please enter the Mobile banner (425px X 499px).",

                    },
                    bannerurl: {

                        required: "Enter the banner url here.",
                    },
