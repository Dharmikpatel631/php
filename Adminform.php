                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST["btnsub"])) {
                            ...
                            $result = mysqli_query($con, "SELECT * FROM tbl_admin where email_id = '$emailid'") or die(mysqli_error($con));
                            $row = mysqli_num_rows($result);
                            if ($row <= 0) {
                                $result = mysqli_query($con, "INSERT INTO  tbl_admin(admin_name,email_id,admin_password) VALUE ('$adminname','$emailid','$password')") or die(mysqli_error($con));
                                if ($result == true) {
                        ?>
                        ...
                        <form method="POST" id="form1">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="adminname" id="adminname" placeholder="Please enter the administrator's name.">

                            </div>
                            <pre></pre>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Email address</label>
                                <input type="email" class="form-control" name="emailid" id="emailid" aria-describedby="emailHelp" placeholder="Please enter the administrator's email address.">

                            </div>
                            <pre></pre>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Password</label>
                                <input type="password" class="form-control" name="password" id="password" placeholder="Please enter the administrator's password">
                            </div>
                            <pre></pre>
